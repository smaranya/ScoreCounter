...
public class Badminton extends AppCompatActivity {
    ...
    public void homeScreen(){
        homeBt = findViewById(R.id.previous_buttonfrombd);
    ...
    public void onHome() {
        AlertDialog.Builder home = new AlertDialog.Builder(Badminton.this);
        if (scoreTeamA == 0 && scoreTeamB == 0) {
        ...
        home.setPositiveButton("Yes", (DialogInterface.OnClickListener) (dialog, which) -> {
            Intent back = new Intent(Badminton.this, MainActivity.class);
            startActivity(back);
        });
