...
public class Basketball extends AppCompatActivity {
    ...
    public void homeScreen(){
        homeBt = findViewById(R.id.previous_button);
    ...
    public void onHome(){
        AlertDialog.Builder home = new AlertDialog.Builder(Basketball.this);
        if(scoreTeamA == 0 && scoreTeamB == 0){
        ...
        home.setPositiveButton("Yes", (DialogInterface.OnClickListener)(dialog, which) -> {
            Intent back = new Intent(Basketball.this, MainActivity.class);
            startActivity(back);
        });
